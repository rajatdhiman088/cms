...
@section('header')
<!-- Header -->
<header class="header text-center text-white" style="background-image: linear-gradient(-225deg, #5D0FFF 0%,  #5D0FFF 48%, #6BBBFF 100%);">
      <div class="container">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-8 col-xl-9">
              ...
              @empty
               <p class="text-center">No, Result Found For The Query::<strong>{{ request()->query('search') }}</strong></p>
              @endforelse
